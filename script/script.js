...
$(".question-00").click(function () {
	if (open00 == true) {
		...
		$(".fleche-question-faq-00").css("rotate", "-90deg");
		open00 = false;
...
$(".question-01").click(function () {
	if (open01 == true) {
		...
		$(".fleche-question-faq-01").css("rotate", "-90deg");
		open01 = false;
...
$(".question-02").click(function () {
	if (open02 == true) {
		...
		$(".fleche-question-faq-02").css("rotate", "-90deg");
		open02 = false;
...
$(".question-03").click(function () {
	if (open03 == true) {
		...
		$(".fleche-question-faq-03").css("rotate", "-90deg");
		open03 = false;
...
$(".question-04").click(function () {
	if (open04 == true) {
		...
		$(".fleche-question-faq-04").css("rotate", "-90deg");
		open04 = false;
...
$(".question-05").click(function () {
	if (open05 == true) {
		...
		$(".fleche-question-faq-05").css("rotate", "-90deg");
		open05 = false;
...
$(".question-06").click(function () {
	if (open06 == true) {
		...
		$(".fleche-question-faq-06").css("rotate", "-90deg");
		open06 = false;
...
$(".question-07").click(function () {
	if (open07 == true) {
		...
		$(".fleche-question-faq-07").css("rotate", "-90deg");
		open07 = false;
...
$(".question-08").click(function () {
	if (open08 == true) {
		...
		$(".fleche-question-faq-08").css("rotate", "-90deg");
		open08 = false;
...
$(".question-09").click(function () {
	if (open09 == true) {
		...
		$(".fleche-question-faq-09").css("rotate", "-90deg");
		open09 = false;
...
$(".question-10").click(function () {
	if (open10 == true) {
		...
		$(".fleche-question-faq-10").css("rotate", "-90deg");
		open10 = false;
...
$(".question-11").click(function () {
	if (open11 == true) {
		...
		$(".fleche-question-faq-11").css("rotate", "-90deg");
		open11 = false;
...
$(".question-12").click(function () {
	if (open12 == true) {
		...
		$(".fleche-question-faq-12").css("rotate", "-90deg");
		open12 = false;
...
$(".question-13").click(function () {
	if (open13 == true) {
		...
		$(".fleche-question-faq-13").css("rotate", "-90deg");
		open13 = false;
...
$(".question-14").click(function () {
	if (open14 == true) {
		$(".question-14").css("height", "9vw");
		$(".fleche-question-faq-14").css("rotate", "-90deg");
		open14 = false;
...
$(".conteneur-dsaa-dnmade").click(function () {
	if (openindex == true) {
		...
		$(".fleche-text-faq").css("rotate", "-90deg");
		openindex = false;
	} else if (openindex == false) {
